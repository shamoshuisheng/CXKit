...
NSString *const layoutheader = @"layoutheader";
...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    indexPaths = [self indexPathForSupplementaryViewsOfKind:layoutheader InRect:rect];
    for(NSIndexPath *indexPath in indexPaths){
        //计算对应的LayoutAttributes
        UICollectionViewLayoutAttributes *attributes = [self layoutAttributesForSupplementaryViewOfKind:layoutheader atIndexPath:indexPath];
        [attributesArray addObject:attributes];
    }
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.headerHeight = self.sectionHeadersBounds?headerHeight:0;
    //找出所有列中高度最小的
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([elementKind isEqualToString:layoutheader]){
        ...
        CGFloat y = MAX(0,
                        offsetY-(height-self.headerHeight));
...
{
    NSMutableArray<NSIndexPath *> *indexPaths = [NSMutableArray array];
    if([kind isEqualToString:layoutheader]){
